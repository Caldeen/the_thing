...
const Projects = () => {
    return (
        <Container>
            ...
            <ol >
                <li>
                    <Typography >This site as a whole built using <b>NextJS</b> framework and <b>MaterialUI</b> library hosted on <i>fly.io</i> using <b>Docker</b> at
                ...
                <br></br>
                <li>
                    <Typography >A simple REST API built using <b>Java Spring Boot</b> hosted on <i>fly.io</i> utilizing 
                ...
                <br></br>
                <li>
                    <Typography>Xkom web scraper in <b>Python</b> running scheduled <b>cron job</b> charted using <b>ChartJs </b>
                ...
                <br></br>
                <li>
                    <Typography><b>Spring boot </b> API used for managing orders <Link href='https://github.com/Caldeen/web_spring_backend'>https://github.com/Caldeen/web_spring_backend</Link>. &#40;2021&#41;</Typography>
                </li>
                <br></br>
                <li>
                    <Typography>Very simple <b>JS</b> game here: <Link href='https://xkom3.fly.dev'>https://xkom3.fly.dev</Link>.</Typography>

    ...
    return (
        <Container>
            ...
            <ol style={{paddingLeft:15}}>
                <li>
                    <Typography sx={{wordWrap:'break-word'}}>This site as a whole built using <b>NextJS</b> framework and <b>MaterialUI</b> library hosted on <i>fly.io</i> using <b>Docker</b> at
                ...
                <br></br>
                <li>
                    <Typography sx={{wordWrap:'break-word'}}>A simple REST API built using <b>Java Spring Boot</b> hosted on <i>fly.io</i> utilizing 
